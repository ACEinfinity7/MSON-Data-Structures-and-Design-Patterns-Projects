...
public class ModOperatorTest {
  ...
  public void setup() {
    ...
    op0 = new Operand<Integer>(7);
    op1 = new Operand<Integer>(5);
  }
  ...
  public void testPerformOperation() {
    ...
    assertEquals("Operator applied to 5 and 7 should produce 5.", 5,  value);
  }

  @Test (timeout = 5000)
  public void testPerformOperationPositiveNumbers() {
    operator.setOperand(0, new Operand<Integer>(4));
    operator.setOperand(1, new Operand<Integer>(12));

    Operand<Integer> result = operator.performOperation();
    int value = result.getValue();
    assertEquals("Operator applied to 12 and 4 should produce 0.", 0,  value);
  }

  @Test (timeout = 5000)
  public void testPerformOperationNegativeNumbers() {
    operator.setOperand(0, new Operand<Integer>(-5));
    operator.setOperand(1, new Operand<Integer>(-21));

    Operand<Integer> result = operator.performOperation();
    int value = result.getValue();
    assertEquals("Operator applied to -21 and -5 should produce -1.", -1,  value);
  }
