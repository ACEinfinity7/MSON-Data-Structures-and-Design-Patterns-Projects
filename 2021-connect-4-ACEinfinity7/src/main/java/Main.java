/**
 * The main driver of the program. This file will create the game, create the
 * two agents, and create the window for the game. After that, Connect4Frame
 * runs everything.
 *
 * <p>
 * You should only modify this class to change which agents are playing. Your
 * options are:
 * </p>
 * <ul>
 * <li>RandomAgent</li>
