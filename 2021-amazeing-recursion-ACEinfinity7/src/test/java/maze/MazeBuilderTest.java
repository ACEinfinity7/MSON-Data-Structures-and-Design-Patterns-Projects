...
public class MazeBuilderTest {
	...
	public void testCreateRoom() {
		RoomInterface room = builder.createRoom(basicDesc, "A smelly room.");
	...
	public void testCreateExit() {
		RoomInterface room = builder.createExit(exitDesc, "A dusty room.");
	...
	public void testAddPassage() {
		RoomInterface r0 = builder.createRoom(basicDesc, "A smelly room.");
		RoomInterface r1 = builder.createRoom(exitDesc, "A dusty room.");
	...
	public void testBuildCircularRooms() {
		RoomInterface r0 = builder.createRoom(basicDesc, "A smelly room.");
		RoomInterface r1 = builder.createRoom(exitDesc, "A dusty room.");
		RoomInterface r2 = builder.createRoom("Another room", "meh.");
		RoomInterface r3 = builder.createRoom("Fourth room", "more.");
		builder.addPassage(r0, r1);
